...
\usepackage{geometry}
\geometry{vmargin=3.5 cm, hmargin=2.5 cm}

\setlength{\parindent}{0 cm}


\title{Jean De La Fontaine \\ Biographie \& Sélection des
meilleures fables}
...
\section{Années de formation (1641-1658)}
...
\section{Au service de Fouquet (1658-1663)}
...
\section{L'apogée de l'activité littéraire (1664-1679)}
...
En 1674, La Fontaine se lance dans un nouveau genre : l'opéra, avec un projet de collaboration avec Jean-Baptiste Lully, qui avorte. C'est l'occasion d'une violente satire de La Fontaine contre Lully, registre rare dans son oeuvre, dans un poème intitulé Le Florentin (Lully était originaire de Florence).
...
\section{Les années 1680, autour de l'Académie}
...
\section{Les dernières années et les dernières fables (1689-1695)}
...
La Fontaine avait composé lui-même son épitaphe3, où il s'attribue un caractère désinvolte et paresseux. Cette paresse revendiquée peut être associée à la facilité de ses oeuvres, qui n'est pourtant qu'apparente :
...
\chapter{Sélection des fables}

\section{Le loup devenu berger}
...
\section{Le corbeau et le renard}
...
\section{Le lièvre et la tortue}
